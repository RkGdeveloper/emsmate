...
<div class="w3-sidebar w3-bar-block w3-card w3-animate-left" style="display:none" id="mySidebar">
  ...
  <div id="id01" class="w3-modal">
    <div class="w3-modal-content w3-card-4 w3-animate-zoom" style="max-width:600px">
      ...
      <sf:form class="w3-container" action="/validateLogin.ems" commandName="logDetails">
        <div class="w3-section">
          <label><b>Admin Username</b></label>
          <sf:input class="w3-input w3-border w3-margin-bottom" path = "userName" type="text" placeholder="Enter Username" name="usrname" required/>
          <label><b>Password</b></label>
          <sf:input class="w3-input w3-border" path="password" type="password" placeholder="Enter Password" name="psw" required/>
